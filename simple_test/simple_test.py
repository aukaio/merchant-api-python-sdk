'''This file is provided as is, as an example of how some mcash merchant API calls look. 
   This file may change at anytime, without notification.
'''
...
def simple_test(my_testbed_token,integrator_name,integrator_rsa_file):
    ...
    integrator_rsa_file = 'test_integrator.pem'
...
if __name__ == '__main__':
    ...
    if options.testbed_token and options.integrator_name and options.integrator_rsa_file:
        simple_test(options.testbed_token,options.integrator_name,options.integrator_rsa_file)
    else:
